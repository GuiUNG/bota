...
/*	let argsJunto = message.content.split(" ").slice(1).join(' ')
	if(argsJunto.length < 1) {
		message.channel.sendMessage('<:vpRedTick:257437215615877129> | Você não deu argumentos da pesquisa.')
	} else {
...
message.channel.sendMessage('<a:loading:529165888172326953> | Este comando está em manutenção.')
}